  ...
  render() {
    return (
      <form className='new-trick-form'>
        ...
        <label htmlFor='name'>
          <input type='text' name='name' placeholder='Name of Trick' value={this.state.name} onChange={event => this.handleChange(event)}/>
        </label>
        ...
        <label htmlFor='link'>
          <input type='text' name='link' placeholder='Link to Tutorial' value={this.state.link} onChange={event => this.handleChange(event)}/>
        </label>
